...
<body>
    ...
    <section class="category">
        ...
        <div class="box-container">
            <a href="category.php?kategori=olahraga" class="box">
                <img src="main-page/images/olahraga.png" alt="">
                <h3>Olahraga</h3>
            </a>
            <a href="category.php?kategori=makanan" class="box">
                <img src="main-page/images/makanan.png" alt="">
                <h3>Makanan</h3>
            </a>
            <a href="category.php?kategori=travelling" class="box">
                <img src="main-page/images/travelling.png" alt="">
                <h3>Travelling</h3>
            </a>
            <a href="category.php?kategori=teknologi" class="box">
                <img src="main-page/images/teknologi.png" alt="">
                <h3>Teknologi</h3>
            </a>
            <a href="category.php?kategori=pendidikan" class="box">
